...
/** The full schedule matrix: [department 0-4][day 0-4][timeSlot 0-1] */
typealias ScheduleMatrix = Array<Array<Array<Course?>>>

/** One department's week: [day 0-4][timeSlot 0-1] */
typealias DaySchedule = Array<Array<Course?>>

/** One day's two time slots: [timeSlot 0-1] */
typealias TimeSlotRow = Array<Course?>

/**
 * Singleton repository that owns the in-memory 3D schedule matrix.
 *
 * Matrix dimensions: [Department (5)][Day (5)][TimeSlot (2)]
 *
...
object ScheduleMatrixManager {
    ...
    data class ScheduleEntry(
        ...
        val department: Department get() = Department.values()[departmentIndex]
